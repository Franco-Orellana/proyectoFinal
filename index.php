...
<body>
    ...
    <main>
        ...
        <section class="section__nosotros" id="elegirnos">
            ...
            <article class="nosotros">
                <div class="nosotros__card">
                    ...
                    <p class="nosotros__parrafo">14 años en el mercado y millones de avisos publicados nos respaldan en la búsqueda de tu propiedad.</p>
                </div>
                <div class="nosotros__card">
                ...
                <div class="nosotros__card">
                    ...
                    <p class="nosotros__parrafo">Pensamos nuestros filtros de avisos para simplificarte la experiencia mientras encuentras tu propiedad.</p>
                </div>
            </article>
        </section>
        ...
        <section class="productos" id="propiedades">
            ...
            <p class="parrafo__secciones">Disfruta buscando en nuestra gran variedad de propiedades</p>
                ...
                <div class="slide-content carrousel">
                    <div class="swiper-wrapper">
                        <div class="seccion__testimonio__card swiper-slide">
                            ...
                            <p>"Todo el proceso fue muy rápido, sencillo y todos estaban dispuestos a ayudar. Agradecido, 100% recomendable. El mejor portal inmobiliario."</p>
                        ...
                        <div class="seccion__testimonio__card swiper-slide">
                            ...
                            <p>"El proceso fué muy claro y el trámite muy rápido. En cuestión de días pude firmar mi contrato sin problemas. Super recomendable."</p>
                        ...
                        <div class="seccion__testimonio__card swiper-slide">
                            ...
                            <p>"El servicio es excelente. Ya no tengo problemas a la hora de publicar mi propiedad, ellos hacen que el proceso de publicación sea agil y fácil."</p>
                        ...
                        <div class="seccion__testimonio__card swiper-slide">
                            ...
                            <p>"¡Estamos muy conformes con el servicio! No tuvimos ningún inconveniente y siempre se manejaron muy rápido sobre todo a la hora de contactarse con el cliente."</p>
                        ...
                        <div class="seccion__testimonio__card swiper-slide">
                            ...
                            <p>"El servicio es excelente. Hemos tenido muy buena atención y asesoría de parte de todos, en general es bastante ágil."</p>
                        ...
                        <div class="seccion__testimonio__card swiper-slide">
                            ...
                            <p>"¡Sin dudas es el mejor portal inmobiliario! Sus servicios son increibles, muy amables y sobre todo te resuelven todos los problemas que puedas tener."</p>
