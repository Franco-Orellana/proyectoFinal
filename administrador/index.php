<?php 
    ...
    session_start();
    if($_POST) {
        if(($_POST['usuario'] == 'franco') && ($_POST['contrasenia'] == 'sistema')) {
            $_SESSION['usuario'] = 'ok';
...
<body class="w-100 min-vh-100 p-0">
    ...
    <main class="d-flex w-100 h-100">
        ...
        <div class="m-auto form-inicio">
            ...
            <span class="me-2">¿No tienes una cuenta?</span><a href="http://" target="_blank" rel="noopener noreferrer">Registrarse</a>
        </div>
    </main>
</body>
</html>