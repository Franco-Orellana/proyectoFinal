<?php
    ...
    switch($accion) {
        ...
        case "Agregar":
            ...
            if($sentenciaSQL ->execute()){
                ...
                if($sentenciaSQL ->execute()){
                    ...
                    $sentenciaSQL = $conexion ->prepare("INSERT INTO casas (img_principal, titulo, categoria, anunciante, ubicacion, direccion, precio, id_detalles, id_imagenes) VALUES (:img_principal, :titulo, :categoria, :anunciante, :ubicacion, :direccion, :precio, :id_detalles, :id_imagenes)");
        ...
        case "Modificar":
            ...
            $sentenciaSQL = $conexion ->prepare("UPDATE casas SET titulo=:nombre, direccion=:direccion, categoria=:categoria, anunciante=:anunciante, ubicacion=:ubicacion, precio=:precio WHERE id=:id");
            $sentenciaSQL ->bindParam(':id',$txtID);
            $sentenciaSQL ->bindParam(':precio',$txtPrecio);
            $sentenciaSQL ->bindParam(':categoria',$txtCategoria);
            $sentenciaSQL ->bindParam(':anunciante',$txtAnunciante);
