...
<div class="container-fluid">
                        ...
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php
                                    ...
                                    echo "<a href='../detalles.php?producto=$casa' target='_blank' class='text-dark'>Ver casa</a>";
                                ?>
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="container-fluid px-0 mt-5">
        ...
        <button type="button" class="d-flex align-items-center btn btn-success mb-4" data-bs-toggle="modal" data-bs-target="#agregarCasa">
            ...
            <span class="ml-1">Agregar casa</span>
        </button>
        ...
        <?php  
            ...
            $sentenciaSQL = $conexion->prepare("SELECT  casas.id, casas.img_principal, casas.titulo, casas.ubicacion, casas.precio, casas.estado,
                                                        categorias.nombre_categoria, detalles.titulo_completo, 
                ...
                <tbody>
                    <?php foreach($listadoDeCasas as $casas) {?>
                        ...
                        <tr>
                            ...
                            <td class="align-middle"><?php echo $casas['nombre_categoria']?></td>
                            <td class="align-middle"><?php echo $casas['titulo']?></td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel">Registrar una nueva casa</h5>
                    ...
                    <div class="modal-body container p-0">
                        <div class="row align-items-center gy-2 card-body">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" name="txtNombre" id="txtNombre" class="form-control" placeholder="Ej: Casa lujosa">
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                <label for="txtUbicacion" class="mb-2">Ubicación:</label>
                                <input type="text" name="txtUbicacion" id="txtUbicacion" class="form-control" placeholder="Ej: Palermo, Buenos Aires">
                            </div>
                            ...
                            <div class="form-group col-lg-2 col-md-6">
                                ...
                                <input type="text" name="txtPrecio" id="txtPrecio" class="form-control" placeholder="Ej: 23415">
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center gy-2 card-body">
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" name="txtTitulo" id="txtTitulo" class="form-control" placeholder="Ej: Casa lujosa con vista al mar">
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" id="txtMapa" name="txtMapa"class="form-control" placeholder="Ej: https://www.google.com/maps/...">
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                <label for="formFileMultiple" class="form-label">Fotos de la casa:</label>
                            ...
                            <div class="form-group col-lg col-sm-12 col-md-6">
                                ...
                                <input type="text" name="txtCantTotales" id="txtCantTotales" class="form-control" placeholder="Ej: 105">
                            </div>
                            <div class="form-group col-lg col-sm-12 col-md-6">
                                <label for="txtCantCubiertos" class="mb-2">Cantidad de m² cubiertos:</label>
                                <input type="text" name="txtCantCubiertos" id="txtCantCubiertos" class="form-control" placeholder="Ej: 84">
                            </div>
                            <div class="form-group col-lg col-sm-12 col-md-6">
                                <label for="txtAmbientes" class="mb-2">Cantidad de ambientes:</label>
                                <input type="text" name="txtAmbientes" id="txtAmbientes" class="form-control" placeholder="Ej: 3">
                            </div>
                            <div class="form-group col-lg col-sm-12 col-md-6">
                                <label for="txtBanios" class="mb-2">Cantidad de baños:</label>
                                <input type="text" name="txtBanios" id="txtBanios" class="form-control" placeholder="Ej: 2">
                            </div>
                            <div class="form-group col-lg col-sm-12 col-md-6">
                                <label for="txtDormitorios" class="mb-2">Cantidad de dormitorios:</label>
                                <input type="text" name="txtDormitorios" id="txtDormitorios" class="form-control" placeholder="Ej: 2">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="txtDescripcion" class="mb-2">Descripción:</label>
                                <textarea class="form-control" name="txtDescripcion" id="txtDescripcion" cols="30" rows="10" style="resize:none;"></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modificarCasa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel">Modificar datos de una casa</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
