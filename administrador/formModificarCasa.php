<?php 
    ...
    $sentenciaSQL = $conexion->prepare("SELECT  casas.id, casas.img_principal, casas.titulo, casas.ubicacion, casas.precio, casas.anunciante,
                                                        categorias.nombre_categoria, categorias.id_categoria, detalles.titulo_completo, 
            ...
            <div class="modal-body container p-0">
                <div class="row align-items-center gy-2 card-body">
                    ...
                    <div class="form-group col-lg-4 col-md-6">
                        ...
                        <input type="text" value="'.$casas['titulo'].'" name="txtNombre" id="txtNombre" class="form-control" placeholder="Categoría de la vivienda">
                    </div>
                    <div class="form-group col-lg-4 col-md-6">
                    ...
                    <div class="form-group col-lg-3 col-md-6">
                        ...
                        <select class="form-select" name="txtCategoria">
                            ...
                            <option selected value="'.$casas['id_categoria'].'">'.$casas['nombre_categoria'].'</option>
                            
                            ';
                        
                                foreach ($sentenciaSQL as $categorias) {
                                    echo '<option value="'.$categorias['id_categoria'].'" '.(($casas['id_categoria'] == $categorias['id_categoria']) ? 'style=display:none;' : '').'>'.$categorias['nombre_categoria'].'</option>';                                 
                                }
                            echo '
                        </select>
                    </div>
