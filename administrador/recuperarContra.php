<?php 
    ...
    if($accion == 'registrar'){
        ...
        elseif(empty($usuario)){
            ...
            //Modificar datos en la tabla usuario
            $sentenciaSQL = $conexion ->prepare("UPDATE usuarios SET contra_usuario=:contraNueva WHERE nombre_usuario=:nombre");
            $sentenciaSQL ->bindParam(':nombre',$nombreUsuario); 
            $sentenciaSQL ->bindParam(':contraNueva',$password);
            $sentenciaSQL ->execute();
