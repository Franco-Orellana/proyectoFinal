...
<body>
    ...
    <main>
        ...
        <?php  
            ...
            $sentenciaSQL = $conexion->prepare("SELECT  casas.id, casas.img_principal, casas.titulo, casas.ubicacion, casas.precio, casas.anunciante, casas.estado,detalles.titulo_completo, 
        ...
        <section class="detalles">
            ...
            <article class="detalles__imagen">
                ...
                <p class="detalles__imagen__ubicacion"><?php echo $casas['ubicacion']?></p>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12 col-xl-8 me-lg-5">
                        <div class="detalles__desc">
                            <h2 class="detalles__desc__titulo"><span class="venta">venta</span>USD <?php echo number_format($casas['precio'], 0, ',', '.');?></h2>
                            <div class="detalles__desc__adicional">
                                <span><?php echo $casas['cant_m2']?> m² Total</span>
                                <i class="bi bi-circle-fill mx-4 mx-md-0"></i>
                                <span><?php echo $casas['cant_m2_cubierto']?> m² Cubiertos</span>
                                <i class="bi bi-circle-fill mx-4 mx-md-0"></i>
                                <span><?php echo $casas['cant_ambientes']?> Ambientes</span>
                                <i class="bi bi-circle-fill mx-4 mx-md-0"></i>
                                <span><?php echo $casas['cant_banios']?> Baños</span>
                                <i class="bi bi-circle-fill mx-4 mx-md-0"></i>
                                <span><?php echo $casas['cant_dormitorios']?> Dormitorios</span>
                            </div>
                        </div>
                        ...
                        <div class="detalles__interior bordes-article">
                            <h2 class="detalles__interior__titulo mb-5">¿Como es el interior?</h2>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                        <div class="d-block d-md-none col position-sticky px-0" style="top: 15%">
                            <ul class="nav nav-tabs w-100" id="myTab" role="tablist">
                                <li class="nav-item w-50" role="presentation">
